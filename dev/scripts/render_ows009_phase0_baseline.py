#!/usr/bin/env python3
"""Render the frozen untouched OWS-009 Phase-0 shipping baseline."""
...
SOURCE_PATH = (
    ...
    "ows_009_atlas_roadside_repair_depot.nbt"
)
...
def main() -> None:
    ...
    if live_blob != baseline_blob:
        raise AssertionError(
            "OWS-009 live shipping NBT no longer matches the frozen baseline; "
    ...
    try:
        ...
        if frozen_bytes != source.read_bytes():
            raise AssertionError("OWS-009 extracted baseline differs from live shipping bytes")
