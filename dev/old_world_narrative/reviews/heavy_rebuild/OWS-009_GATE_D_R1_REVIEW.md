...
The Heavy Rebuild doctrine and the candidate explicitly require direct inspection of the committed Gate-D PNG artifacts: four exterior quarters, roof/top oblique, fixed Y<=6 interior cutaway, floor slices and contact sheet. The current execution environment can read repository text and image metadata but cannot retrieve repository binary image content for direct inspection. Attempted binary access failed at the connector/runtime boundary.
...
This is an evidence boundary, not a failed structure finding. **Gate D remains open.**
...
1. acquire direct binary/view access to the already committed Gate-D r1 review artifacts;
...
5. do not advance OWS-010 while OWS-009 remains Gate-D-open.

## Claim

OWS-009 Gate-D r1 has completed every deterministic/static verification available from the committed evidence reviewed here. It has **not** completed independent visual Gate-D acceptance, runtime/new-world acceptance, or final production admission.
