...
LINES = [
    ...
    '\tquest.5AB0550C00000003.quest_desc: ["Recover the Abyssal Navigation Core from the wreck and carry it back into the settlement spawn buffer. Evidence only matters if civilization gets it home."]',
    ...
    '\tquest.5AB0550C00000006.quest_desc: ["Bring the recovered Karsic Subsea Data Recorder back into the settlement spawn buffer for analysis."]',
