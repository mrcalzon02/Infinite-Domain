...
def generate_suits() -> None:
    resources = ROOT / "packdev" / "stellaris-space-industry" / "src" / "main" / "resources"
...
def generate_quests() -> None:
    ...
    lines = ["{", "\tdefault_hide_dependency_lines: false", "\tdefault_quest_shape: \"gear\"", "\tfilename: \"stellaris_space_industrialization\"", "\tgroup: \"7C5A000000000001\"", f"\tid: \"{chapter_id}\"", "\ticon: \"infinite_domain_space:emergency_helmet\"", "\torder_index: 0", "\tquests: ["]
    branches = [
...
"""
    write(ROOT / "docs" / "stellaris-space-industry.md", text)
