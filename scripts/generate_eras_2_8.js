  ...
  5: {
    ...
    branches:{
      ...
      B:{name:'Farming and Biological Production',contribution:'era5_farming_contribution',common:'create:mechanical_harvester',quests:[
        ...
        q('Livestock Without Neglect',null,1,'Automate collection while preserving breeding stock, space, and server-safe entity limits.','Commission a server-safe livestock system'),
  ...
  6: {
    ...
    branches:{
      ...
      B:{name:'Farming and Biological Production',contribution:'era6_farming_contribution',common:'minecraft:golden_apple',quests:[
        q('Protected Agriculture',null,1,'Establish a food-growing area outside the exclusion zone with isolated water and soil.','Commission protected agriculture'),
        ...
        q('Decontamination Station',null,1,'Build a marked clean/dirty boundary with replacement clothing and sealed storage.','Commission a decontamination station'),
...
require('child_process').execFileSync(process.execPath, [path.join(__dirname, 'build_organic_metallurgy_quests.js')], { stdio: 'inherit' })
require('child_process').execFileSync(process.execPath, [path.join(__dirname, 'build_reautomated_quest_line.js')], { stdio: 'inherit' })
